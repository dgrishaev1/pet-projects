...
export const apiLanguageGetAll = async (params: Language.All.Search): Promise<Language.Data[]> => {
  const { data } = await ApiService(true).get<Language.Data[]>("/languages", { params });
  return data;
};
