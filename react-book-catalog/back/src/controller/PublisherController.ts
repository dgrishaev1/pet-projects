...
export const publisherGetById: App.Action<Publisher.Single.Request> = async (req, res) => {
...
export const publisherDelete: App.Action<Publisher.Delete.Request> = async (req, res) => {
  await schemaPublisherValidateId.validate(req.params);
